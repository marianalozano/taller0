...
public class ConsolaOlimpicos
{
	...
	public void ejecutarAplicacion()
	{
		...
		while (continuar)
		{
			try
			{
				...
				else if (opcion_seleccionada == 13 && calculadora != null) //taller 1
					ejecuarAtletaespecifico();
	...
	public void mostrarMenu()
	{
		...
		System.out.println("*13. Consultar pais atleta especifico");//taller 1
	...
	public String ejecuarPaisAtletaespecifico() //taller 1
	{
		...
		String atletaNombre = input("Por favor ingrese el nombre de un atleta");
		String pais = calculadora.atletaPais(atletaNombre);
		
		System.out.println("El atelta " + atletaNombre + " pertenece al pais " + pais);
